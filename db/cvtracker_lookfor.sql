...
CREATE TABLE `lookfor` (
  `lookfor_id` int(11) NOT NULL AUTO_INCREMENT,
  `lookfor_name` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`lookfor_id`)
...
INSERT INTO `lookfor` VALUES (1,'resume'),(2,'vacancy');
...
-- Dump completed on 2012-12-31  8:04:27
